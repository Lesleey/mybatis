...
public abstract class VFS {
  ...
  public static void addImplClass(Class<? extends VFS> clazz) {
    ...
    /**
     *  通过线程上下文加载器对名称为className进行类加载， 获取类对象
     * */
...
//      return ReflectUtil.findClass(className);
  ...
  /**
   *   通过递归的方式寻找该url下，路径为 forPath之下的所有资源的绝对路径
   *
