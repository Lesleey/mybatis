...
class AnnotationMapperBuilderTest {
  ...
  void withOptions() {
    ...
    Assertions.assertEquals(mappedStatement.getFetchSize(),200);
  ...
  interface Mapper {
    ...
    @Options(fetchSize = 200, timeout = 10, statementType = StatementType.STATEMENT, resultSetType = ResultSetType.SCROLL_INSENSITIVE, useCache = false)
